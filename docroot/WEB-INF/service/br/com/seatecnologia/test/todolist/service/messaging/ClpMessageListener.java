...
package br.com.seatecnologia.test.todolist.service.messaging;
...
import br.com.seatecnologia.test.todolist.service.TaskListServiceUtil;
import br.com.seatecnologia.test.todolist.service.TaskLocalServiceUtil;
import br.com.seatecnologia.test.todolist.service.TaskServiceUtil;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			TaskListServiceUtil.clearService();
		}
	}
}